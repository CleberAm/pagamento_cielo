...
$customer = $sale->customer($_POST['primeiroNome'] . ' ' . $_POST['segundoNome']);
...
$payment->setType(Payment::PAYMENTTYPE_CREDITCARD)
        ->creditCard($_POST['codSeguranca'], CreditCard::VISA)
        ->setExpirationDate($_POST['validade'])
        ->setCardNumber($_POST['numeroCartao'])  
        ->setHolder($_POST['primeiroNome'] . ' ' . $_POST['segundoNome']);
